...
#
#	UPDATE COMMENTS:
#	1. change from .ini to .yml file
#	2. Need to follow eos guidelines...
#
...
print ""
print "=-----------="
#print "cfg is a ", type(cfg), cfg
print "=-----------="
print "main items are", type(cfg['WJetsToLNu_HT_800To1200']), cfg['WJetsToLNu_HT_800To1200']
print "=-----------="
print "main is a list, the first item is a dictionary", type(cfg['WJetsToLNu_HT_800To1200'][0]), cfg['WJetsToLNu_HT_800To1200'][0]
#print "=-----------="
#print "main[0] is a dict, the first item is", cfg['WJetsToLNu_HT_800To1200'][0]['users'][0]
...
source = "/store/user/rasharma/SecondStep/WWTree_2017_12_15_01h36/"
...
Arrayfilepath = []
print "=========================="
for root, dirs, filenames in os.walk("/eos/uscms"+source):
	for f in filenames:
		#filepath = root + os.sep + f
		filepath = f
		if filepath.endswith(".root"):
			Arrayfilepath.append(filepath.replace("/eos/uscms",""))
			print filepath.replace("/eos/uscms","")
...
for i,files in enumerate(Arrayfilepath):
	for section in cfg:
		if files.find(section) != -1:
			print files
			file = ROOT.TFile("root://cmsxrootd.fnal.gov/"+source+"/"+files)
			if not file:
