...
if __name__ == '__main__':
    ...
    parser.add_argument ('-i', '--inputFolder' , default = '/store/user/lpcbacon/15/' , help='input folder with the reduced trees')
    ...
    parser.add_argument ('-n', '--name' , default = 'ttHTobb_M125_TuneCP5_13TeV_powheg_pythia8' , help='input file')
