...
void setOutputTree::initializeVariables()
{
  ...
  AK4_jet_size=-999;
  AK4_maxpt_j1_pt=-999;
  AK4_maxpt_j1_eta=-999;
  AK4_maxpt_j1_phi=-999;
  AK4_maxpt_j1_e=-999;
  AK4_maxpt_j1_bDiscriminatorCSV=-999;
  AK4_maxpt_j2_pt=-999;
  AK4_maxpt_j2_eta=-999;
  AK4_maxpt_j2_phi=-999;
  AK4_maxpt_j2_e=-999;
  AK4_maxpt_j2_bDiscriminatorCSV=-999;
  AK4_maxpt_j3_pt=-999;
  AK4_maxpt_j3_eta=-999;
  AK4_maxpt_j3_phi=-999;
  AK4_maxpt_j3_e=-999;
  AK4_maxpt_j3_bDiscriminatorCSV=-999;
  AK4_maxpt_j4_pt=-999;
  AK4_maxpt_j4_eta=-999;
  AK4_maxpt_j4_phi=-999;
  AK4_maxpt_j4_e=-999;
  AK4_maxpt_j4_bDiscriminatorCSV=-999;
  vbf_maxpt_j1_pt=-999;
...
void setOutputTree::setBranches()
{
  ...
  fTree->Branch("AK4_jet_size",&AK4_jet_size,"AK4_jet_size/I");
  fTree->Branch("AK4_maxpt_j1_pt",&AK4_maxpt_j1_pt,"AK4_maxpt_j1_pt/F");
  fTree->Branch("AK4_maxpt_j1_eta",&AK4_maxpt_j1_eta,"AK4_maxpt_j1_eta/F");
  fTree->Branch("AK4_maxpt_j1_phi",&AK4_maxpt_j1_phi,"AK4_maxpt_j1_phi/F");
  fTree->Branch("AK4_maxpt_j1_e",&AK4_maxpt_j1_e,"AK4_maxpt_j1_e/F");
  fTree->Branch("AK4_maxpt_j1_bDiscriminatorCSV",&AK4_maxpt_j1_bDiscriminatorCSV,"AK4_maxpt_j1_bDiscriminatorCSV/F");
  fTree->Branch("AK4_maxpt_j2_pt",	&AK4_maxpt_j2_pt,	"AK4_maxpt_j2_pt/F");
  fTree->Branch("AK4_maxpt_j2_eta",	&AK4_maxpt_j2_eta,	"AK4_maxpt_j2_eta/F");
  fTree->Branch("AK4_maxpt_j2_phi",	&AK4_maxpt_j2_phi,	"AK4_maxpt_j2_phi/F");
  fTree->Branch("AK4_maxpt_j2_e",	&AK4_maxpt_j2_e,	"AK4_maxpt_j2_e/F");
  fTree->Branch("AK4_maxpt_j2_bDiscriminatorCSV",&AK4_maxpt_j2_bDiscriminatorCSV,"AK4_maxpt_j2_bDiscriminatorCSV/F");
  fTree->Branch("AK4_maxpt_j3_pt",&AK4_maxpt_j3_pt,"AK4_maxpt_j3_pt/F");
  fTree->Branch("AK4_maxpt_j3_eta",&AK4_maxpt_j3_eta,"AK4_maxpt_j3_eta/F");
  fTree->Branch("AK4_maxpt_j3_phi",&AK4_maxpt_j3_phi,"AK4_maxpt_j3_phi/F");
  fTree->Branch("AK4_maxpt_j3_e",&AK4_maxpt_j3_e,"AK4_maxpt_j3_e/F");
  fTree->Branch("AK4_maxpt_j3_bDiscriminatorCSV",&AK4_maxpt_j3_bDiscriminatorCSV,"AK4_maxpt_j3_bDiscriminatorCSV/F");
  fTree->Branch("AK4_maxpt_j4_pt",&AK4_maxpt_j4_pt,"AK4_maxpt_j4_pt/F");
  fTree->Branch("AK4_maxpt_j4_eta",&AK4_maxpt_j4_eta,"AK4_maxpt_j4_eta/F");
  fTree->Branch("AK4_maxpt_j4_phi",&AK4_maxpt_j4_phi,"AK4_maxpt_j4_phi/F");
  fTree->Branch("AK4_maxpt_j4_e",&AK4_maxpt_j4_e,"AK4_maxpt_j4_e/F");
  fTree->Branch("AK4_maxpt_j4_bDiscriminatorCSV",&AK4_maxpt_j4_bDiscriminatorCSV,"AK4_maxpt_j4_bDiscriminatorCSV/F");
