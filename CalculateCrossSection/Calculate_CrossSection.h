...
// Fri Aug  4 19:26:55 2017 by ROOT version 6.06/01
// from TTree Events/Events
// found on file: /eos/cms/store/user/arapyan/Run2/WplusToLNuWminusTo2JJJ_EWK_LO_aQGC_MJJ100PTJ10_TuneCUETP8M1_13TeV-madgraph-pythia8/Samples/170726_154909/0000/Output_1.root
//////////////////////////////////////////////////////////

#ifndef Calculate_CrossSection_h
#define Calculate_CrossSection_h
...
class Calculate_CrossSection {
public :
   TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   Int_t           fCurrent; //!current Tree number in a TChain

// Fixed size dimensions of array or collections stored in the TTree if any.
   static const Int_t kMaxGenParticle = 123;
   static const Int_t kMaxLHEWeight = 1164;
   static const Int_t kMaxElectron = 6;
   static const Int_t kMaxMuon = 32;
   static const Int_t kMaxTau = 13;
   static const Int_t kMaxPhoton = 7;
   static const Int_t kMaxPV = 84;
   static const Int_t kMaxAK4CHS = 18;
   static const Int_t kMaxAK8CHS = 6;
   static const Int_t kMaxAddAK8CHS = 6;
   static const Int_t kMaxAK4Puppi = 14;
 ...
 //bitset<256>     AK8Puppi_hltMatchBits[kMaxAK8Puppi];
   ...
   Calculate_CrossSection(TTree *tree=0);
   virtual ~Calculate_CrossSection();
...
#ifdef Calculate_CrossSection_cxx
Calculate_CrossSection::Calculate_CrossSection(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/cms/store/user/arapyan/Run2/WplusToLNuWminusTo2JJJ_EWK_LO_aQGC_MJJ100PTJ10_TuneCUETP8M1_13TeV-madgraph-pythia8/Samples/170726_154909/0000/Output_1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/eos/cms/store/user/arapyan/Run2/WplusToLNuWminusTo2JJJ_EWK_LO_aQGC_MJJ100PTJ10_TuneCUETP8M1_13TeV-madgraph-pythia8/Samples/170726_154909/0000/Output_1.root");
      }
...
Calculate_CrossSection::~Calculate_CrossSection()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Calculate_CrossSection::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Calculate_CrossSection::LoadTree(Long64_t entry)
{
...
void Calculate_CrossSection::Init(TTree *tree)
{
...
Bool_t Calculate_CrossSection::Notify()
{
...
void Calculate_CrossSection::Show(Long64_t entry)
{
...
Int_t Calculate_CrossSection::Cut(Long64_t entry)
{
...
#endif // #ifdef Calculate_CrossSection_cxx
