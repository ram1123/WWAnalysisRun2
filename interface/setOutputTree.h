...
class setOutputTree {
 ...
 public:
  ...
  float trig_eff_Weight_Up;
  float trig_eff_Weight2_Up;
  float trig_eff_Weight_Down;
  float trig_eff_Weight2_Down;
  float id_eff_Weight;
  float id_eff_Weight2;
  float id_eff_Weight_Up;
  ...
  float ZeppenfeldWL_type0_LEP_Down;
  float BosonCentrality_2Lep_jes_up;
  float BosonCentrality_2Lep_jes_dn;
  float BosonCentrality_2Lep_LEP_Up;
  float BosonCentrality_2Lep_LEP_Down;
  float ZeppenfeldWL_2Lep_jes_up;
  float ZeppenfeldWL_2Lep_jes_dn;
  float ZeppenfeldWL_2Lep_LEP_Up;
  float ZeppenfeldWL_2Lep_LEP_Down;
  ...
  float dilep_m_Up;
  float dilep_pt_Down;
  float dilep_eta_Down;
  float dilep_phi_Down;
  float dilep_m_Down;
...
float AK8jet_qjet;
  ...
  int   ungroomed_PuppiAK8_jet_charge;
...
float PuppiAK8jet_qjet;
  ...
  float v_pt_type2;
  float v_pt_type0;
  float v_pt_type0_LEP_Up;
  float v_pt_type0_LEP_Down;
  float v_pt_run2;
  float v_eta_type2;
  float v_eta_type0;
  float v_eta_run2;
  ...
  float v_mass_type2;
  float v_mass_type0;
  float v_mass_type0_LEP_Up;
  float v_mass_type0_LEP_Down;
  float v_mass_run2;
  ...
  float mass_lvj_type0_PuppiAK8_LEP_Down;
  ...
  float mass_llj_PuppiAK8_LEP_Down;
  ...
  float vbf_maxpt_j1_px;
  float vbf_maxpt_j1_py;
  float vbf_maxpt_j1_pz;
  ...
  int   vbf_maxpt_j1_charge;
  float vbf_maxpt_j2_pt;
  float vbf_maxpt_j2_px;
  float vbf_maxpt_j2_py;
  float vbf_maxpt_j2_pz;
